...
const CreateProposalModal = React.forwardRef(
...
const handleUpdateProposal = async () => {
  try {
    ...
    Toast.show({
      type: "success",
      text1: "Proposal Updated",
      text2: "Proposal details updated successfully",
    });
    ...
    Toast.show({
      ...
      text2:
        ...
        "Something went wrong while updating proposal",
    });
  } finally {
    setLoading(false);
  }
